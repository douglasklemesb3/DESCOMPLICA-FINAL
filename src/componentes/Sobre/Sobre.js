...
const Sobre = () => {
    return (
        <div className="Tudo">
            ...
            <p>Na cidade de Caieiras a população obtinha um certo nível de  dificuldades para realizar inscrições nas atividades oferecidos pela Prefeitura Municipal de Caieiras, para isso criamos a plataforma digital DESCOMPLICA.</p>
            </div>
            <div>
            <p>
            No DESCOMPLICA o usuário consegue realizar a sua inscrição nos cursos e entretenimentos disponíveis virtualmente.
            </p>
            </div>
